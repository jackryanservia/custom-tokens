...
describe('SignatureToken', () => {
  let deployerAccount: PublicKey,
    ...
    zkApp: SignatureToken;

  beforeAll(async () => {
    if (proofsEnabled) await SignatureToken.compile();
  });
  ...
  beforeEach(() => {
    ...
    zkApp = new SignatureToken(zkAppAddress);
  });
  ...
  it('generates and deploys the `SignatureToken` smart contract', async () => {
    await localDeploy();
  ...
  it('mints custom tokens using the `SignatureToken` smart contract (signature)', async () => {
    await localDeploy();
  ...
  it('mints custom tokens using the `SignatureToken` smart contract (proof)', async () => {
    await localDeploy();
  ...
  it('burns custom tokens using the `SignatureToken` smart contract (proof)', async () => {
    await localDeploy();
  ...
  it('transfers custom tokens using the `SignatureToken` smart contract (proof)', async () => {
    await localDeploy();
